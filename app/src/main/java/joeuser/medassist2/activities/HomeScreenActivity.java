...
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_patients) {
            // Handle the list of patient activity intent
            Intent intent = new Intent(this, CurrentPatientsActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_add_patient) {
            // Handle the add patient activity intent

        } else if (id == R.id.nav_settings) {
            // Handle the settings activity intent
            ...
            // Handle the calender activity intent
